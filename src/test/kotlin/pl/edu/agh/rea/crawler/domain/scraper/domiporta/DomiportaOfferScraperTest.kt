...
class DomiportaOfferScraperTest : BaseOfferScraperTest("domiporta") {
    ...
    override fun getTestParameters(): Map<String, Offer> = mapOf(
            ...
            getResourceUrl("offer_page8.html") to Offer(
                    ...
                    "Sosnowiec, Zagórze, Kielecka",
                    "https://galeria.domiporta.pl/pictures/big/9/c2/2d/c00206dec6eeffeb0fca2695a5db5e90/sprzedam-mieszkanie-sosnowiec-zagorze.jpg.jpg",
                    201_600.0,
                    42.0,
                    2,
                    0,
